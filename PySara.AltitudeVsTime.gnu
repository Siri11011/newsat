...
plot \
'PySara.Compound_of-SOLAR_PANEL+X-SOLAR_PANEL-X-SOLAR_PANEL+Y-Solar_panel-y-SOLAR_PANEL+Z-SOLAR_PANEL-Z-Structure.17276616445358212567_Trajectory.txt' using 1:2 w l lw 1 title '', \
'PySara.Compound_of-Solar_panel-y-SOLAR_PANEL+Y-SOLAR_PANEL+Z-SOLAR_PANEL-Z-Structure.9873595915830574375_Trajectory.txt' using 1:2 w l lw 1 title '', \
'PySara.Compound_of-SOLAR_PANEL+Y-SOLAR_PANEL+Z-SOLAR_PANEL-Z-Structure.2614653640415779736_Trajectory.txt' using 1:2 w l lw 1 title '', \
'PySara.Compound_of-SOLAR_PANEL+Z-SOLAR_PANEL-Z-Structure.937004453408318760_Trajectory.txt' using 1:2 w l lw 1 title '', \
'PySara.Structure.a8639e99-0008-45a4-b2da-5ab048880d15_Trajectory.txt' using 1:2 w l lw 1 title '', \
